...
struct CLIArgs {
	...
	var model: String = UMGeminiLite.Model.gemini36Flash.codeName // model
...
func runCLI() async {
	...
	let selectedModel = UMGeminiLite.Model(codeName: args.model) ?? .gemini36Flash //  u m gemini lite. model(code name

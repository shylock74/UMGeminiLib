...
struct CLIArgs {
	...
	var model: String = UMGeminiLite.Model.gemini37Flash.codeName // model
...
func runCLI() async {
	...
	let selectedModel = UMGeminiLite.Model(codeName: args.model) ?? .gemini37Flash //  u m gemini lite. model(code name
